...
export function CommitScreen({ persona, onBack, onConfirm }: Props) {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6 px-4 py-6">
      ...
      <div>
        <h1 className="text-xl font-semibold tracking-tight text-neutral-50">Commit to one rule</h1>
      ...
      <button
        ...
        className="w-full rounded-2xl bg-amber-500 px-4 py-3 text-sm font-semibold text-neutral-950 transition-all duration-150 hover:bg-amber-400 active:scale-[0.99]"
      >
        Commit to this rule
      </button>
    </div>
